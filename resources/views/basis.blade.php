      ...
      <div class="modal-body">
        <form>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="kode_gangguan" placeholder="Masukkan Kode Gangguan">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="kode_indikasi" class="form-label">Kode Indikasi</label>
                <input type="text" class="form-control" id="kode_indikasi" placeholder="Masukkan Kode Indikasi">
            </div>
            <div class="mb-3">
                <label for="nama_indikasi" class="form-label">Nama Indikasi</label>
                <input type="text" class="form-control" id="nama_indikasi" placeholder="Masukkan Nama Indikasi">
